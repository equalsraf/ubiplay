...
class TestNoVLC(unittest.TestCase):
    """
    Tests for when VLC is not present
    """
    ...
    def test_ws(self):
        """REST services return error object w/ code 500"""
        for rule in app.url_map.iter_rules():
            ...
            self.assertEquals(resp.status_code, 500, rule.rule)
